  ...
  return (
    <header className="pt-8">
      ...
      <p className="mt-2 max-w-2xl text-[15px] leading-relaxed text-alia-ink-soft">
        Your popup reaches every visitor. This module verifies that it is usable by every visitor
        too, running a live WCAG&nbsp;2.2 and ADA audit alongside the Alia editor you already use.
      </p>
    </header>
  );
}
